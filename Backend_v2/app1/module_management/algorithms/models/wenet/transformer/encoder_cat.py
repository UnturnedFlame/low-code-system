...
from wenet.conformer_test.ffn_invert import Mlp_Light as Lffn
...
from wenet.conformer_test.subsampling2 import Conv2dSubsampling2 as MBV2Subsampling2
...
class BaseEncoder(torch.nn.Module):
    def __init__(
        ...
        if input_layer == "linear":
            ...
            # subsampling_class = MBV2Subsampling2
        else:
